...
import dev.jibovico.apps.sharem.misc.OsCompat;
import dev.jibovico.apps.sharem.misc.Utils;
import dev.jibovico.apps.sharem.provider.DocumentsProvider;
import dev.jibovico.apps.sharem.provider.UsbStorageProvider;

import static dev.jibovico.apps.sharem.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "dev.jibovico.apps.sharem.action.DOCUMENTS_PROVIDER";
     ...
     * {@link dev.jibovico.apps.sharem.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link dev.jibovico.apps.sharem.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link dev.jibovico.apps.sharem.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link dev.jibovico.apps.sharem.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link dev.jibovico.apps.sharem.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
