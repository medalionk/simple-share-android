...
import dev.jibovico.apps.sharem.usb.UsbUtils;

import static dev.jibovico.apps.sharem.DocumentsApplication.isTelevision;
import static dev.jibovico.apps.sharem.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "dev.jibovico.apps.sharem.action.USB_PERMISSION";
