...
import dev.jibovico.apps.sharem.archive.DocumentArchiveHelper;
import dev.jibovico.apps.sharem.fragment.ConnectionsFragment;
import dev.jibovico.apps.sharem.fragment.CreateDirectoryFragment;
import dev.jibovico.apps.sharem.fragment.CreateFileFragment;
import dev.jibovico.apps.sharem.fragment.DirectoryFragment;
import dev.jibovico.apps.sharem.fragment.HomeFragment;
import dev.jibovico.apps.sharem.fragment.MoveFragment;
import dev.jibovico.apps.sharem.fragment.PickFragment;
import dev.jibovico.apps.sharem.fragment.RecentsCreateFragment;
import dev.jibovico.apps.sharem.fragment.RootsFragment;
import dev.jibovico.apps.sharem.fragment.SaveFragment;
import dev.jibovico.apps.sharem.fragment.ServerFragment;
import dev.jibovico.apps.sharem.libcore.io.IoUtils;
import dev.jibovico.apps.sharem.misc.AnalyticsManager;
import dev.jibovico.apps.sharem.misc.AppRate;
import dev.jibovico.apps.sharem.misc.AsyncTask;
import dev.jibovico.apps.sharem.misc.ConnectionUtils;
import dev.jibovico.apps.sharem.misc.ContentProviderClientCompat;
import dev.jibovico.apps.sharem.misc.CrashReportingManager;
import dev.jibovico.apps.sharem.misc.IntentUtils;
import dev.jibovico.apps.sharem.misc.MimePredicate;
import dev.jibovico.apps.sharem.misc.PermissionUtil;
import dev.jibovico.apps.sharem.misc.PinViewHelper;
import dev.jibovico.apps.sharem.misc.PinViewHelper.PINDialogFragment;
import dev.jibovico.apps.sharem.misc.ProviderExecutor;
import dev.jibovico.apps.sharem.misc.RootsCache;
import dev.jibovico.apps.sharem.misc.SAFManager;
import dev.jibovico.apps.sharem.misc.SystemBarTintManager;
import dev.jibovico.apps.sharem.misc.Utils;
import dev.jibovico.apps.sharem.model.DocumentInfo;
import dev.jibovico.apps.sharem.model.DocumentStack;
import dev.jibovico.apps.sharem.model.DocumentsContract;
import dev.jibovico.apps.sharem.model.DocumentsContract.Root;
import dev.jibovico.apps.sharem.model.DurableUtils;
import dev.jibovico.apps.sharem.model.RootInfo;
import dev.jibovico.apps.sharem.network.NetworkConnection;
import dev.jibovico.apps.sharem.provider.ExternalStorageProvider;
import dev.jibovico.apps.sharem.provider.RecentsProvider;
import dev.jibovico.apps.sharem.provider.RecentsProvider.RecentColumns;
import dev.jibovico.apps.sharem.provider.RecentsProvider.ResumeColumns;
import dev.jibovico.apps.sharem.setting.SettingsActivity;
import dev.jibovico.apps.sharem.ui.DirectoryContainerView;
import dev.jibovico.apps.sharem.ui.FloatingActionsMenu;
import dev.jibovico.apps.sharem.ui.fabs.SimpleMenuListenerAdapter;

import static dev.jibovico.apps.sharem.BaseActivity.State.ACTION_BROWSE;
import static dev.jibovico.apps.sharem.BaseActivity.State.ACTION_CREATE;
import static dev.jibovico.apps.sharem.BaseActivity.State.ACTION_GET_CONTENT;
import static dev.jibovico.apps.sharem.BaseActivity.State.ACTION_MANAGE;
import static dev.jibovico.apps.sharem.BaseActivity.State.ACTION_OPEN;
import static dev.jibovico.apps.sharem.BaseActivity.State.ACTION_OPEN_TREE;
import static dev.jibovico.apps.sharem.BaseActivity.State.MODE_GRID;
import static dev.jibovico.apps.sharem.BaseActivity.State.MODE_LIST;
import static dev.jibovico.apps.sharem.DocumentsApplication.isTelevision;
import static dev.jibovico.apps.sharem.fragment.DirectoryFragment.ANIM_DOWN;
import static dev.jibovico.apps.sharem.fragment.DirectoryFragment.ANIM_NONE;
import static dev.jibovico.apps.sharem.fragment.DirectoryFragment.ANIM_SIDE;
import static dev.jibovico.apps.sharem.fragment.DirectoryFragment.ANIM_UP;
import static dev.jibovico.apps.sharem.misc.AnalyticsManager.FILE_COUNT;
import static dev.jibovico.apps.sharem.misc.AnalyticsManager.FILE_MOVE;
import static dev.jibovico.apps.sharem.misc.AnalyticsManager.FILE_TYPE;
import static dev.jibovico.apps.sharem.misc.SAFManager.ADD_STORAGE_REQUEST_CODE;
import static dev.jibovico.apps.sharem.misc.Utils.EXTRA_ROOT;
import static dev.jibovico.apps.sharem.provider.ExternalStorageProvider.isDownloadAuthority;
