...
package dev.jibovico.apps.sharem.loader;
...
import dev.jibovico.apps.sharem.cursor.FilteringCursorWrapper;
import dev.jibovico.apps.sharem.cursor.RootCursorWrapper;
import dev.jibovico.apps.sharem.cursor.SortingCursorWrapper;
import dev.jibovico.apps.sharem.fragment.DirectoryFragment;
import dev.jibovico.apps.sharem.libcore.io.IoUtils;
import dev.jibovico.apps.sharem.misc.AsyncTaskLoader;
...
import static dev.jibovico.apps.sharem.BaseActivity.State.SORT_ORDER_DISPLAY_NAME;
import static dev.jibovico.apps.sharem.BaseActivity.State.SORT_ORDER_LAST_MODIFIED;
import static dev.jibovico.apps.sharem.BaseActivity.State.SORT_ORDER_SIZE;
