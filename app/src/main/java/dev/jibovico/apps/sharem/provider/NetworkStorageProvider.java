...
import dev.jibovico.apps.sharem.network.NetworkFile;

import static dev.jibovico.apps.sharem.misc.MimeTypes.BASIC_MIME_TYPE;
...
import static dev.jibovico.apps.sharem.provider.ExplorerProvider.ConnectionColumns;
