package dev.jibovico.apps.sharem.apps;
...
import dev.jibovico.apps.sharem.misc.PackageManagerUtils;
import dev.jibovico.apps.sharem.misc.Utils;

import static dev.jibovico.apps.sharem.misc.PackageManagerUtils.ACTION_FORCE_STOP_FINISHED;
import static dev.jibovico.apps.sharem.misc.PackageManagerUtils.FORCE_STOP_STRING_LEFT_BOTTON;
import static dev.jibovico.apps.sharem.misc.PackageManagerUtils.FORCE_STOP_STRING_RES_NAME;
import static dev.jibovico.apps.sharem.misc.PackageManagerUtils.FORCE_STOP_STRING_RIGHT_BOTTON;
import static dev.jibovico.apps.sharem.misc.PackageManagerUtils.OK_STRING_RES_NAME;
