...
package dev.jibovico.apps.sharem.provider;
...
import dev.jibovico.apps.sharem.libcore.util.Objects;
...
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_COMPRESS_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_COPY_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_CREATE_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_DELETE_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_IS_CHILD_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_MOVE_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_REMOVE_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_RENAME_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.METHOD_UNCOMPRESS_DOCUMENT;
import static dev.jibovico.apps.sharem.model.DocumentsContract.buildDocumentUri;
import static dev.jibovico.apps.sharem.model.DocumentsContract.buildDocumentUriMaybeUsingTree;
import static dev.jibovico.apps.sharem.model.DocumentsContract.buildTreeDocumentUri;
import static dev.jibovico.apps.sharem.model.DocumentsContract.getDocumentId;
import static dev.jibovico.apps.sharem.model.DocumentsContract.getRootId;
import static dev.jibovico.apps.sharem.model.DocumentsContract.getSearchDocumentsQuery;
import static dev.jibovico.apps.sharem.model.DocumentsContract.getTreeDocumentId;
import static dev.jibovico.apps.sharem.model.DocumentsContract.isTreeUri;
