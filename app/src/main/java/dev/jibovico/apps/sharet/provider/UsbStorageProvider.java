...
import dev.jibovico.apps.sharet.usb.UsbUtils;

import static dev.jibovico.apps.sharet.DocumentsApplication.isTelevision;
import static dev.jibovico.apps.sharet.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "dev.jibovico.apps.sharet.action.USB_PERMISSION";
