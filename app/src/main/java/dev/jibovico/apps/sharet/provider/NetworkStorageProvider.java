...
import dev.jibovico.apps.sharet.network.NetworkFile;

import static dev.jibovico.apps.sharet.misc.MimeTypes.BASIC_MIME_TYPE;
...
import static dev.jibovico.apps.sharet.provider.ExplorerProvider.ConnectionColumns;
