...
package dev.jibovico.apps.sharet;
...
import dev.jibovico.apps.sharet.archive.DocumentArchiveHelper;
import dev.jibovico.apps.sharet.fragment.ConnectionsFragment;
import dev.jibovico.apps.sharet.fragment.CreateDirectoryFragment;
import dev.jibovico.apps.sharet.fragment.CreateFileFragment;
import dev.jibovico.apps.sharet.fragment.DirectoryFragment;
import dev.jibovico.apps.sharet.fragment.HomeFragment;
import dev.jibovico.apps.sharet.fragment.MoveFragment;
import dev.jibovico.apps.sharet.fragment.PickFragment;
import dev.jibovico.apps.sharet.fragment.RecentsCreateFragment;
import dev.jibovico.apps.sharet.fragment.RootsFragment;
import dev.jibovico.apps.sharet.fragment.SaveFragment;
import dev.jibovico.apps.sharet.fragment.ServerFragment;
import dev.jibovico.apps.sharet.libcore.io.IoUtils;
import dev.jibovico.apps.sharet.misc.AnalyticsManager;
import dev.jibovico.apps.sharet.misc.AppRate;
import dev.jibovico.apps.sharet.misc.AsyncTask;
import dev.jibovico.apps.sharet.misc.ConnectionUtils;
import dev.jibovico.apps.sharet.misc.ContentProviderClientCompat;
import dev.jibovico.apps.sharet.misc.CrashReportingManager;
import dev.jibovico.apps.sharet.misc.IntentUtils;
import dev.jibovico.apps.sharet.misc.MimePredicate;
import dev.jibovico.apps.sharet.misc.PermissionUtil;
import dev.jibovico.apps.sharet.misc.PinViewHelper;
import dev.jibovico.apps.sharet.misc.PinViewHelper.PINDialogFragment;
import dev.jibovico.apps.sharet.misc.ProviderExecutor;
import dev.jibovico.apps.sharet.misc.RootsCache;
import dev.jibovico.apps.sharet.misc.SAFManager;
import dev.jibovico.apps.sharet.misc.SystemBarTintManager;
import dev.jibovico.apps.sharet.misc.Utils;
import dev.jibovico.apps.sharet.model.DocumentInfo;
import dev.jibovico.apps.sharet.model.DocumentStack;
import dev.jibovico.apps.sharet.model.DocumentsContract;
import dev.jibovico.apps.sharet.model.DocumentsContract.Root;
import dev.jibovico.apps.sharet.model.DurableUtils;
import dev.jibovico.apps.sharet.model.RootInfo;
import dev.jibovico.apps.sharet.network.NetworkConnection;
import dev.jibovico.apps.sharet.provider.ExternalStorageProvider;
import dev.jibovico.apps.sharet.provider.RecentsProvider;
import dev.jibovico.apps.sharet.provider.RecentsProvider.RecentColumns;
import dev.jibovico.apps.sharet.provider.RecentsProvider.ResumeColumns;
import dev.jibovico.apps.sharet.setting.SettingsActivity;
import dev.jibovico.apps.sharet.ui.DirectoryContainerView;
import dev.jibovico.apps.sharet.ui.FloatingActionsMenu;
import dev.jibovico.apps.sharet.ui.fabs.SimpleMenuListenerAdapter;

import static dev.jibovico.apps.sharet.BaseActivity.State.ACTION_BROWSE;
import static dev.jibovico.apps.sharet.BaseActivity.State.ACTION_CREATE;
import static dev.jibovico.apps.sharet.BaseActivity.State.ACTION_GET_CONTENT;
import static dev.jibovico.apps.sharet.BaseActivity.State.ACTION_MANAGE;
import static dev.jibovico.apps.sharet.BaseActivity.State.ACTION_OPEN;
import static dev.jibovico.apps.sharet.BaseActivity.State.ACTION_OPEN_TREE;
import static dev.jibovico.apps.sharet.BaseActivity.State.MODE_GRID;
import static dev.jibovico.apps.sharet.BaseActivity.State.MODE_LIST;
import static dev.jibovico.apps.sharet.DocumentsApplication.isTelevision;
import static dev.jibovico.apps.sharet.fragment.DirectoryFragment.ANIM_DOWN;
import static dev.jibovico.apps.sharet.fragment.DirectoryFragment.ANIM_NONE;
import static dev.jibovico.apps.sharet.fragment.DirectoryFragment.ANIM_SIDE;
import static dev.jibovico.apps.sharet.fragment.DirectoryFragment.ANIM_UP;
import static dev.jibovico.apps.sharet.misc.AnalyticsManager.FILE_COUNT;
import static dev.jibovico.apps.sharet.misc.AnalyticsManager.FILE_MOVE;
import static dev.jibovico.apps.sharet.misc.AnalyticsManager.FILE_TYPE;
import static dev.jibovico.apps.sharet.misc.SAFManager.ADD_STORAGE_REQUEST_CODE;
import static dev.jibovico.apps.sharet.misc.Utils.EXTRA_ROOT;
import static dev.jibovico.apps.sharet.provider.ExternalStorageProvider.isDownloadAuthority;
