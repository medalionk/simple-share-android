package dev.jibovico.apps.sharet.setting;
...
import static dev.jibovico.apps.sharet.setting.SettingsActivity.KEY_FILE_HIDDEN;
import static dev.jibovico.apps.sharet.setting.SettingsActivity.KEY_FILE_SIZE;
import static dev.jibovico.apps.sharet.setting.SettingsActivity.KEY_FILE_THUMBNAIL;
import static dev.jibovico.apps.sharet.setting.SettingsActivity.KEY_FOLDER_SIZE;
import static dev.jibovico.apps.sharet.setting.SettingsActivity.KEY_RECENT_MEDIA;
