package dev.jibovico.apps.sharet.network;
...
import dev.jibovico.apps.sharet.misc.LogUtils;
import dev.jibovico.apps.sharet.model.Durable;
...
import dev.jibovico.apps.sharet.provider.ExplorerProvider.ConnectionColumns;
import dev.jibovico.apps.sharet.provider.NetworkStorageProvider;

import static dev.jibovico.apps.sharet.model.DocumentInfo.getCursorBolean;
