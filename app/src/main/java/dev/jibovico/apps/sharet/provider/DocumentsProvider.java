...
package dev.jibovico.apps.sharet.provider;
...
import dev.jibovico.apps.sharet.libcore.util.Objects;
...
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_COMPRESS_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_COPY_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_CREATE_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_DELETE_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_IS_CHILD_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_MOVE_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_REMOVE_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_RENAME_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.METHOD_UNCOMPRESS_DOCUMENT;
import static dev.jibovico.apps.sharet.model.DocumentsContract.buildDocumentUri;
import static dev.jibovico.apps.sharet.model.DocumentsContract.buildDocumentUriMaybeUsingTree;
import static dev.jibovico.apps.sharet.model.DocumentsContract.buildTreeDocumentUri;
import static dev.jibovico.apps.sharet.model.DocumentsContract.getDocumentId;
import static dev.jibovico.apps.sharet.model.DocumentsContract.getRootId;
import static dev.jibovico.apps.sharet.model.DocumentsContract.getSearchDocumentsQuery;
import static dev.jibovico.apps.sharet.model.DocumentsContract.getTreeDocumentId;
import static dev.jibovico.apps.sharet.model.DocumentsContract.isTreeUri;
