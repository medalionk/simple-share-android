...
package dev.jibovico.apps.sharet.loader;
...
import dev.jibovico.apps.sharet.cursor.FilteringCursorWrapper;
import dev.jibovico.apps.sharet.cursor.RootCursorWrapper;
import dev.jibovico.apps.sharet.cursor.SortingCursorWrapper;
import dev.jibovico.apps.sharet.fragment.DirectoryFragment;
import dev.jibovico.apps.sharet.libcore.io.IoUtils;
import dev.jibovico.apps.sharet.misc.AsyncTaskLoader;
...
import static dev.jibovico.apps.sharet.BaseActivity.State.SORT_ORDER_DISPLAY_NAME;
import static dev.jibovico.apps.sharet.BaseActivity.State.SORT_ORDER_LAST_MODIFIED;
import static dev.jibovico.apps.sharet.BaseActivity.State.SORT_ORDER_SIZE;
