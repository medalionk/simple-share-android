...
import static dev.jibovico.apps.sharet.R.id.action_close;
import static dev.jibovico.apps.sharet.R.id.action_feedback;
import static dev.jibovico.apps.sharet.R.id.action_rate;
